...
import { FlaskRound, ChevronRight } from "lucide-react";

export default function LabPanel() {
  const { data: patients = [], isLoading } = useAssignedPatients("laboratorio");
  ...
  return (
    <div className="space-y-4 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-muted-foreground">Pacientes con estudios solicitados que requieren resultados.</p>
